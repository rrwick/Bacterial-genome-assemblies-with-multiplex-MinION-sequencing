...
BASECALLED_NANOPORE=04_basecalled_nanopore_reads
RAW_NANOPORE=05_raw_nanopore_reads
TRIMMED_NANOPORE=06_trimmed_nanopore_reads
SUBSAMPLED_NANOPORE=07_subsampled_nanopore_reads
UNICYCLER_ILLUMINA_ASSEMBLIES=08_unicycler_illumina_only_assemblies
SPADES_ILLUMINA_ASSEMBLIES=08_spades_illumina_only_assemblies
...
SPADES_HYBRID_ASSEMBLIES=11_spades_hybrid_assemblies
BASECALLED_NANOPORE_FAST5_FILES=12_basecalled_nanopore_reads_fast5
READS_FOR_NANOPOLISH=13_nanopore_reads_for_nanopolish
NANOPOLISHED_CANU_ASSEMBLIES=14_nanopolish_canu_assemblies
NANOPOLISHED_UNICYCLER_NANOPORE_ASSEMBLIES=15_nanopolish_unicycler_long_read_only_assemblies
PILON_POLISHED_CANU_ASSEMBLIES=16_pilon_polish_canu_assemblies
